...
namespace KisaanMart.Controllers
{
    public class WorkersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,UserPhoneNo")] Worker worker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,UserPhoneNo")] Worker worker)
        {
            if (id != worker.Id)
            {
                return NotFound();
